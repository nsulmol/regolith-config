...
- The default gruvbox theme *did not work* well for all applications (particularly, libreoffice). We were getting not very visible icons.

  To fix it, I went into /usr/share/regolith-look/gruvbox/root and changed gtk.theme_name and gtk.icon_theme_name to Yaru-sage-dark.
